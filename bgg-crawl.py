...
for loc in soup.find_all("loc"):
    ...
    filename = url[url.rindex("sitemap_")+len("sitemap_"):] + '.xml'
    ...
    open(path, "wb").write(body) #some of the pages were throwing back errors because they were "bytes" and not "str", adding the "wb" should fix this
